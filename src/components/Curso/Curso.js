    ...
    <Grid item xs={12} sm={6} md={4} lg={3}>
      <Card className={classes.card}>
        <div className={classes.cardHeader}>
          ...
          <IconButton className={classes.optionsButton} onClick={optionsOpenHandler}>
            <MoreVertIcon />
          </IconButton>
          <Menu anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} onClose={optionsCloseHandler}>
            <MenuItem onClick={optionsCloseHandler}>Profile</MenuItem>
            <MenuItem onClick={optionsCloseHandler}>My account</MenuItem>
            <MenuItem onClick={optionsCloseHandler}>Logout</MenuItem>
          </Menu>
        </div>
            ...
            <Table size="small">
              ...
              <TableBody>
                {props.horario.map((horario, index) => (
                  <TableRow key={index}>
                    <TableCell align="center">{horario.dia}</TableCell>
                    <TableCell align="center">{horario.hora}</TableCell>
                    <TableCell align="center">{horario.salon}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
