          ...
          <Tooltip title={props.reactivos ? "Abierto" : "Crear examen"} placement="left">
            <Fab color="primary" size="small" className={classes.extendedIcon} style={{ top: "calc(100% - 130px)" }}>
              {props.reactivos ? (
                <SubjectIcon
                  onClick={() => {
                    history.push("/examen/" + props.materia_id + "/" + props.id + "/reactivo/abierto");
                  }}
                />
              ) : (
                <LibraryBooksSharpIcon
                  onClick={() => {
                    history.push("/examen/" + props.materia_id + "/" + props.id + "/crear");
                  }}
                />
              )}
            </Fab>
            ...
            <Fab color="primary" size="small" className={classes.extendedIcon} style={{ top: "calc(100% - 180px)" }}>
              {props.reactivos ? (
                <FormatListBulletedIcon
                  onClick={() => {
                    history.push("/examen/" + props.materia_id + "/" + props.id + "/reactivo/fv");
                  }}
                />
              ) : (
                <StorageOutlinedIcon
                  onClick={() => {
                    history.push("/examen/" + props.materia_id + "/" + props.id + "/reactivos");
                  }}
                />
              )}
            </Fab>
            ...
            <Tooltip title="Opción múltiple" placement="left">
              <Fab color="primary" size="small" className={classes.extendedIcon} style={{ top: "calc(100% - 230px)" }}>
                <FormatListNumberedIcon
                  onClick={() => {
                    history.push("/examen/" + props.materia_id + "/" + props.id + "/reactivo/multiple");
                  }}
                />
              </Fab>
            </Tooltip>
