...
function getSteps() {
  return ["Pregunta 1", "Pregunta 2", "Pregunta 3", "Pregunta 4", "Pregunta 5"];
}
...
export default function ExamenesStepper() {
  ...
  return (
    <div className={classes.root}>
      ...
      <div>
        {allStepsCompleted() ? (
          <div>
            <Typography className={classes.instructions}>Ya terminaste!</Typography>
            <Button onClick={handleReset}>Finalizar intento</Button>
          </div>
        ) : (
          <div>
