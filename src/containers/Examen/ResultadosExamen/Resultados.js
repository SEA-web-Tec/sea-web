...
class Resultados extends Component {
  render(props) {
    ...
    const resultados = [
      ...
      {
        texto_reactivo:
          "¿De quien depende Android para los servicios base del sistema como seguridad, gestión de memoria, gestión de procesos, pila de red y modelo de controladores?",
            ...
            <AccordionDetails>
              <Box component="div">
                <Typography className={classes.answer}>
                  Aquí se vería la respuesta que el alumno eligió o ingresó, debe aparecer al dar click sobre un alumno y deberá
                  aparecer por default la respuesta defecto la respuesta del primer alumno:{" "}
                  {resultados[n].respuestas[0].respuesta_alumno}.
                </Typography>
              </Box>
            </AccordionDetails>
            <AccordionActions>
